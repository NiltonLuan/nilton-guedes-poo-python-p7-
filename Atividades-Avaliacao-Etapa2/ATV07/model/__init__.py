from ATV07 import db
from ATV07.model.tabelas import Cliente, Produto, NotaFiscal, ItemNotaFiscal
...
def criar_inicial():
    cliente1 = Cliente("Nilton Barros", '100', '200.100.345-34', 'pessoa fisica')
    cliente2 = Cliente("Joao Vitor", '200', '123.456.789-10', 'pessoa fisica')
    cliente3 = Cliente("Ricardo Taveira", '300', '109.876.543-21', 'pessoa fisica')
